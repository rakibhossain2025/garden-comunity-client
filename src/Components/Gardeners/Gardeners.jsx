    ...
    <div className="max-w-6xl mx-auto px-4 py-12">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        {activeGardeners.map((gardener) => (
          <div
            key={gardener._id}
            className={`w-full rounded-2xl shadow-md hover:shadow-2xl transition-transform duration-300 hover:-translate-y-1 overflow-hidden ${theme === 'dark' ? 'bg-gray-800 text-[#52F757]' : 'bg-white text-black'
              }`}
          >
