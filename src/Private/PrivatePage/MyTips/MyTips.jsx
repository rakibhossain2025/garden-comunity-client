...
const MyTips = () => {
  ...
  return (<>{
    myTips.length !== 0 ?
      ...
      <div className={`mb-12 relative min-h-[500px] flex flex-col gap-3 ${theme !== "dark" ? 'bg-white' : 'bg-black'}`}>
        <div className=''>
        ...
        <div className='flex flex-col bg-no-repeat bg-center justify-center items-center'>
          <img src="https://i.ibb.co/hxdJSwhH/istockphoto-1281404534-612x612-1.png" alt="" className='h-[500px] mb-1' />
        </div >
